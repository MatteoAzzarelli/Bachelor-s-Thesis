...
%	\end{frame}
	...
	\begin{frame}{MOSS: Funzionamento}
		...
		\end{center}
		\vspace{-0.5cm}{\footnotesize \textbf{2)} Per ogni documento vine effettuata una nuova fingerprint, ottenendo una lista di fingerprint per ciascun documento. Ora ogni documento \texttt{d} può contenere fingerprint di molti altri documenti \texttt{d1,d2,...}.}
	\end{frame}
